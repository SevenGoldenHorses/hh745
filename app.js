...
var fs = require('fs')
var logger = fs.createWriteStream('report_MMark7272.txt', {
...
function BOMBA(tweet) {
	...
	if ( tweet.user.screen_name !== 'MMark7272' ) {
